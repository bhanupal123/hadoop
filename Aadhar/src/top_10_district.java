...
//top 10 district with aadhar registration
...
public class top_10_district  {
	...
	{	
		public void map(LongWritable key,Text value,Context context) throws IOException, InterruptedException
		{
			...
			context.write(new Text(a[3]), new IntWritable(Integer.parseInt(a[8])));
		}
	...
	public static void main(String[] args) throws Exception  {
		...
		stateWiseCount.setJarByClass(top_10_district.class);
		...
		sort.setJarByClass(top_10_district.class);		
