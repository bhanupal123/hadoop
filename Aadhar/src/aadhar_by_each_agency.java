...
//Count the number of identities(Aadhaar) generated in each agency
...
public class aadhar_by_each_agency  {
	static class map1 extends Mapper<LongWritable,Text,Text,IntWritable>
	{	
		public void map(LongWritable key,Text value,Context context) throws IOException, InterruptedException
		{
			String[] a=value.toString().split(",");
			context.write(new Text(a[1]), new IntWritable(Integer.parseInt(a[8])));
		}
	...
	public static void main(String[] args) throws Exception  {
		...
		stateWiseCount.setJarByClass(aadhar_by_each_agency.class);
		...
		sort.setJarByClass(aadhar_by_each_agency.class);		
